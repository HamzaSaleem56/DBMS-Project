          ...
          <div class="card flex-fill">
            ...
            <div class="card-body py-0">
              <div class="row g-3">
                ...
                <div class="col-12">
                    <input type="time" name="time_in" class="form-control" id="time_in" placeholder="{{ __('time_in') }}" value="{{ old('time_in') }}" required />
                  </div>
                  <div class="col-12">
                    <input type="time" name="time_out" class="form-control" id="time_out" placeholder="{{ __('time_out') }}" value="{{ old('time_out') }}" required />
                  </div>
              </div>
            </div>
